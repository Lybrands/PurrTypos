...
>
> 历史说明：本文是上一轮改造的完成记录，不定义本轮 Core 拆分或剧本对话重写边界。当前权威章程见 [`docs/design/agent-core-screenplay-refactor-charter.md`](design/agent-core-screenplay-refactor-charter.md)。
