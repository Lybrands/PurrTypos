...
const BasicInput = React.forwardRef<InputRef, InputProps>(function BasicInput(
  {
    size = 'middle',
    prefix,
    suffix,
...
const Password = React.forwardRef<InputRef, InputProps>(function Password(props, ref) {
...
const Search = React.forwardRef<InputRef, SearchProps>(function Search(
...
export const Input = BasicInput as InputComponent
