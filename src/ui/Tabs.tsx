...
/** 项目内 Tabs 入口，使用 items/activeKey API，交互由 Base UI 管理。 */
export function Tabs({ items, activeKey, defaultActiveKey, onChange, className, destroyOnHidden = false, onEdit, tabBarExtraContent }: TabsProps) {
