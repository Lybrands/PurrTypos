...
_hiddenimports = [
    ...
    "services.skill_planner",
    "services.skill_orchestrator",
    "services.agent_tool_definitions",
    "services.expert_team_config",
    "services.expert_team_autogen",
    "autogen_agentchat",
    ...
    "autogen_core",
    "services.subagent_config",
    "services.subagent_shared",
    "services.subagent_pipeline",
    "services.subagent_graph",
    "langgraph",
    "langgraph.graph",
    "langchain_core",
    "services.embedding",
