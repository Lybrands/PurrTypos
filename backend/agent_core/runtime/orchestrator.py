...
from agent_core.host_planned_tool_gateway import (
...
from agent_core.runtime.tool_round import (
            ...
            if termination.incomplete:
                truncation_decision = await self._decide_recovery(
                    ...
                    RecoveryRequest(
                        ...
                        # A resolved task budget is a host decision. Retrying
                        # the same request with the same allowance cannot fix
                        # truncation and used to duplicate expensive work.
                        # Legacy direct Runtime callers without a decision keep
                        # their bounded clean-retry behavior.
                        retryable=termination.retryable and output_budget is None,
                        cancellation_requested=_is_canceled(signal),
                        visible_output_emitted=direct_content_released,
                    ),
                    round_number=round_number,
