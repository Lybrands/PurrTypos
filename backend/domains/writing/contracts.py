...
class WritingDomainContext:
    ...
    writing_technique_snapshot: Mapping[str, Any] | None = None
    ...
    def __post_init__(self) -> None:
        object.__setattr__(self, "writing_technique_snapshot", dict(self.writing_technique_snapshot or {}))
    ...
    def to_core_context(self) -> DomainContext:
        return DomainContext(
            ...
            payload={
                ...
                "writing_technique_snapshot": dict(self.writing_technique_snapshot or {}),
    ...
    def from_core_context(cls, context: DomainContext) -> "WritingDomainContext":
        ...
        if payload.get("writing_method_binding_snapshot") or payload.get("writing_method_overrides") or payload.get("writing_method_recommendation_requested"):
            raise ValueError("旧版写作技法协议已退役，请重新发起写作请求")
        return cls(
            writing_technique_input_id=_optional_identifier(payload.get("writing_technique_input_id")),
            writing_technique_snapshot=_mapping(payload.get("writing_technique_snapshot")),
